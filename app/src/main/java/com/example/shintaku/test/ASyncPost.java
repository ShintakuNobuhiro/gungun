...
public class ASyncPost extends AsyncTask<Void, Void, Void> {
    ...
    // 生成時
    public ASyncPost( Activity parent_activity, String post_url, Handler ui_handler )
    {
        // 初期化
            ...
            public Void handleResponse(HttpResponse response) throws IOException
            {
                ...
                switch (response.getStatusLine().getStatusCode()) {
                    case HttpStatus.SC_OK:
                        ...
                        // ※IOExceptionの可能性あり
                        ASyncPost.this.http_ret_msg = EntityUtils.toString(
                                response.getEntity(),
                                ASyncPost.this.response_encoding
                        );
                        break;
                    ...
                    case HttpStatus.SC_NOT_FOUND:
                        ...
                        ASyncPost.this.http_err_msg = "404 Not Found";
                        break;

                    default:
                        Log.d("posttest", "通信エラー");
                        ASyncPost.this.http_err_msg = "通信エラーが発生";
                }
